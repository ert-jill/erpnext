- Enhancements
	...
	- Other Features
		...
		- A free marketplace where any IJEert user can list their products and be discovered by thousands of other companies using IJEert
...
- Changes have been made to ensure IJEert is compatible with Python 3
